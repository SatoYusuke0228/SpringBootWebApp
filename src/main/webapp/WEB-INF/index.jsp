			...
			<section class="area">
				<div class="area3">
					<div id="slidewrap">
						<div id="slidemask">
							<ul id="photo">
								<c:forEach items="${productList}" var="p">
									<li id="slide01"><img
										src="image/${p.productPhotoFileName1}" height="350px"
										width="275px" alt=" ${p.productName}"> <span>
											${p.productName} </span></li>
									<li id="slide02"><img
										src="image/${p.productPhotoFileName1}" height="350px"
										width="275px" alt=" ${p.productName}"> <span>
											${p.productName} </span></li>
						...
						<!--/#slidemask-->
						<ul id="thumb">
							<li id="thumb01"><a href="product-list.html"> <img
									src="image/sample-1.jpg" alt="">
							</a></li>
							<li id="thumb02"><a href="product-list.html"> <img
									src="image/sample-2.jpg" alt="">
							</a></li>
							<li id="thumb03"><a href="product-list.html"> <img
									src="image/sample-3.jpg" alt="">
							</a></li>
							<li id="thumb04"><a href="product-list.html"> <img
									src="image/sample-4.jpg" alt="">
							</a></li>
						</ul>
					</div>
				</div>
